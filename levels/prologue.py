...
class Prologue:
    def __init__(self, screen_width, screen_height):
        ...
        self.presenter_text = (
            ...
            "You are watching a show about the most famous inhabitants of our country.",
            "Our guest today is the most famous detective, Persimmona.",
        )
        self.presenter_question = ("Persimmona, tell me, how did you become so famous?",)
        self.persimmona_text = (
            "Oh, yes, I remember exactly the day it happened,",
            "It was one of the most interesting investigations of my life!",
